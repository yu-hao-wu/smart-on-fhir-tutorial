    ...
    function onReady(smart)  {
      if (smart.hasOwnProperty('user')) {
       ...
       // console.log('people are:', people);                             
        ...
        smart.api.search({type: "Observation", query: {code: '39156-5', recordedDate: 'le2012-08-18'}})
        .then(function(bundle){
        console.log('Body Mass Index', bundle)
        });

        smart.api.search({type: "Condition", query: {code: '72892002', recordedDate: 'le2012-08-18'}})
        .then(function(bundle){
